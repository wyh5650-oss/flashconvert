...
- **文档**：Markdown / HTML / DOCX / EPUB / ODT / RTF / TXT 互转（Pandoc，首次使用自动下载，内置国内镜像）；MD/DOCX 等一键转 PDF（内置 Chromium 打印引擎，阅读器排版直出）；**PDF 反向转换**——PDF→PNG/JPG 逐页高清渲染、PDF→TXT/Word/MD 文本提取（PDF.js）；装有 LibreOffice 时 Office→PDF 走更高保真路径
